...
export default {
  ...
  data() {
    ...
    let _currentDateMonth =
      currentDateMonth < 9
        ? "0" + (currentDateMonth + 1)
        : currentDateMonth + 1;
    let _currentDateDate =
      currentDateDate < 10 ? "0" + currentDateDate : currentDateDate;
    let _lastDateMonth =
      lastDateMonth < 9 ? "0" + (lastDateMonth + 1) : lastDateMonth + 1;
